      ...
      <div class="container"> 
        ...
        <div class="row">
          <div class="col-lg-8 text-center text-lg-left">
            <h2 class="text-7 font-weight-600 mb-3">I'm <span class="text-primary">Ojukwu Nelson Sopuruchukwu. </span> a Backend Engineer</h2>
              ...
              @foreach ( $services as $service)
                ...
                <div class="col-md-6">
                  <div class="featured-box style-3 mb-5 ">
                    <div class="featured-box-icon text-primary bg-white shadow-sm rounded"> <i class="{{$service->icon}}"></i></div>
                    <h3>{{$service->title}}</h3>
        ...
        <div class="row"> 
          ...
          <div class="col-md-6">
            ...
            @foreach ($educations as $education )
             <div class="bg-white border rounded p-4 mb-4">
              <p class="badge badge-primary text-2 font-weight-400">{{$education->year}}</p>
              <h3 class="text-5">{{$education->course}}</h3>
              <p class="text-danger">{{$education->school}}</p>
          ...
          <div class="col-md-6">
            ...
            @foreach ($qualifications as $qualification )
              <div class="bg-white border rounded p-4 mb-4">
              <p class="badge badge-primary text-2 font-weight-400">{{$qualification->year}}</p>
              @if ($qualification->certLink == 'not set')
                <h3 class="text-5">{{$qualification->cert}}</h3>
              @else

                <h3 class="text-5"><a href="{{$qualification->certLink}}"  style="color: black;"> {{$qualification->cert}} </a></h3>

              @endif
              
              <p class="text-danger">{{$qualification->academy}}</p>
